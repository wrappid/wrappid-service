...
export class AuthController extends BaseController {
  ...
  // async getUsers(req: Request, res: Response): Promise<string> {
  //   console.log(`getUsers called!!!`);
  //   return "Hello";
  // }
  // async getById(req: Request, res: Response): Promise<string> {
...
ControllerRegistry.register("AuthController", AuthController);
