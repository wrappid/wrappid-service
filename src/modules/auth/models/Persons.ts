...
export class Persons extends Model<personsAttributes, personsAttributes> implements personsAttributes {
    ...
    @Column({
    	...
    	defaultValue: Sequelize.literal("'2023-09-04 17:51:20.406'::timestamp without time zone") 
    })
    	dob?: Date;
